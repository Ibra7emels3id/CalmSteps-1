...
import { usePackages } from "../../store/usePackage";
                            ...
                            >
                                ...
                                <div className="relative h-[250px] overflow-hidden ">
                                    ...
                                    <div className="absolute bottom-0 right-0 z-10 p-4 text-white">
                                        ...
                                        <p className="text-sm text-white/90">{pkg?.description.slice(0, 50)}...</p>
                                    </div>
                                ...
                                <div className="p-6 bg-white flex flex-col flex-grow">
                                    ...
                                    <ul className="space-y-3 mb-6 flex-grow">
                                        {pkg?.services?.map((feature, i) => {
                                            const isString = typeof feature === "string";
                                            const featureText = isString ? feature : feature?.service?.name;
