...
export default function Booking() {
    ...
    // Calculate total price based on selected packages and services
    ...
    const handlePaymentWithGeidea = async () => {
        if (selectedPackages.length === 0 && selectedServices.length === 0) {
            alert("يرجى اختيار باقة واحدة على الأقل أو خدمة واحدة على الأقل.");
            return;
        }
        ...
        Navigate("/payment");
        console.log("Payment with Geidea:", formData, selectedPackages, selectedServices);
    };
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 border-2 bg-white border-soft-gray rounded-lg focus:outline-none focus:border-soft-green transition-colors"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 border-2 bg-white border-soft-gray rounded-lg focus:outline-none focus:border-soft-green transition-colors resize-none"
                                    rows={4}
